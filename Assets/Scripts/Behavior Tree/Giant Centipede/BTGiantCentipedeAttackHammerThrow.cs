...
{
    public class BTGiantCentipedeAttackHammerThrow : Action
    {

        [SerializeField] private Units.SharedEnemyManager actor;
        [SerializeField] private GameObject hammerthrowPrefab;
        ...
        private IEnumerator DoAbility()
        {
            ...
            {
                Object.Instantiate(hammerthrowPrefab, new Vector3(transform.position.x, transform.position.y + 2, -0.01f), Quaternion.identity);
